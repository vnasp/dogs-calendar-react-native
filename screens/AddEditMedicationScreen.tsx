      ...
      <ScrollView className="flex-1 bg-white rounded-t-3xl px-6 pt-6">
              ...
              >
                ...
                <Text
                  className={`text-lg font-semibold ${
                    selectedDogId === dog.id ? "text-pink-700" : "text-gray-900"
                  }`}
                >
                  {dog.name}
                </Text>
        ...
        <View className="mb-4">
          ...
          <TextInput
            ...
            placeholder="Ej: 150 mg, 1 comprimido"
            className="bg-white px-4 py-3 rounded-xl text-gray-900"
            placeholderTextColor="#9CA3AF"
          />
        </View>
        ...
        <View className="mb-4">
          ...
          <View>
            ...
            <TextInput
              ...
              className="bg-white px-4 py-3 rounded-xl text-gray-900 border border-gray-200"
              placeholderTextColor="#9CA3AF"
            />
          </View>
        </View>
